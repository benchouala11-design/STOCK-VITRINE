...
export function App() {
  ...
  return (
    <LanguageProvider>
      <div className="min-h-screen bg-slate-100 text-slate-900 flex flex-col font-sans selection:bg-indigo-500/20 selection:text-indigo-900 overflow-x-hidden relative">
        ...
        <main className="flex-1 flex flex-col">
          ...
          {/* ── Wave Divider: Dark → Warm (Sectors → Download) ── */}
          <div className="relative -mt-1">
            <svg viewBox="0 0 1440 80" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-14 sm:h-20 block" preserveAspectRatio="none">
              <path d="M0 30L60 28C120 26 240 22 360 25.3C480 28.7 600 39.3 720 40C840 40.7 960 31.3 1080 26.7C1200 22 1320 22 1380 22L1440 22V0H1380C1320 0 1200 0 1080 0C960 0 840 0 720 0C600 0 480 0 360 0C240 0 120 0 60 0H0V30Z" fill="#f8fafc"/>
          ...
          {/* ── Wave Divider: Warm → Dark (Testimonials → Contact) ── */}
          <div className="relative -mt-1">
            <svg viewBox="0 0 1440 80" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-14 sm:h-20 block" preserveAspectRatio="none">
