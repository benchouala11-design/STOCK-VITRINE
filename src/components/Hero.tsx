...
export const Hero: React.FC = () => {
  ...
  return (
    <section 
      id="home" 
      className="relative flex flex-col pt-24 pb-8 sm:pt-32 sm:pb-12 overflow-hidden bg-[#f8fafc]"
    >
      ...
      <motion.div 
        ...
        className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 mt-12 sm:mt-16"
      >
        <SoftwareMockup />
      </motion.div>
