...
export const Hero: React.FC = () => {
  ...
  return (
    <section 
      id="home" 
      className="relative flex flex-col pt-24 pb-8 sm:pt-28 sm:pb-10 overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950"
    >
      {/* BACKGROUND GRAPHICS: DISCREET GRID */}
      <div className="absolute inset-0 bg-grid-pattern-dark opacity-70 pointer-events-none -z-10"></div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center space-y-5">
        ...
        <motion.div 
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-400/10 border border-indigo-400/30 text-indigo-200 text-xs sm:text-sm font-bold shadow-sm backdrop-blur-md hover:border-indigo-300/60 transition-colors mx-auto"
        >
        ...
        >
          ...
          <a
            href="#contact"
            className="inline-flex items-center justify-center px-6 py-4 rounded-xl text-base font-bold text-white bg-white/5 hover:bg-white/10 border border-white/15 hover:border-white/25 shadow-sm backdrop-blur-md transition-all duration-200 transform hover:-translate-y-0.5 active:translate-y-0 text-center group"
          >
        ...
        >
          <div className="flex items-center gap-2 text-slate-200 font-semibold">
            <div className="w-5 h-5 rounded-full bg-emerald-400/10 border border-emerald-400/40 flex items-center justify-center text-emerald-400 shrink-0">
              <CheckCircle2 className="w-3.5 h-3.5" />
            </div>
            <span>{t.hero.benefits.offline}</span>
          </div>
          <div className="flex items-center gap-2 text-slate-200 font-semibold">
            <div className="w-5 h-5 rounded-full bg-indigo-400/10 border border-indigo-400/40 flex items-center justify-center text-indigo-300 shrink-0">
              <CheckCircle2 className="w-3.5 h-3.5" />
            </div>
            <span>{t.hero.benefits.bilingual}</span>
          </div>
          <div className="flex items-center gap-2 text-slate-200 font-semibold">
            <div className="w-5 h-5 rounded-full bg-amber-400/10 border border-amber-400/40 flex items-center justify-center text-amber-300 shrink-0">
              <CheckCircle2 className="w-3.5 h-3.5" />
            </div>
